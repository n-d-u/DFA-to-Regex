...
def calinout(intermediateStates, dfa):
    # global dfa
    mp = []
...
def Convertor():
    ...
    ieedges = calinout(intermediateStates,dfa)
    ...
    while sizetrans != 1 and sizeinterm > 0:
        ...
        inc, out, selfloops = getAllTransitions(stateToRemove, dfa)
